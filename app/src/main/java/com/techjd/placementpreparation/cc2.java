...
public class cc2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wvcc2);
        progressBar = findViewById(R.id.pbcc2);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/cocubes%2FVerbal%20English%20and%20Comprehension.pdf?alt=media&token=0f591e21-516e-445f-8bcc-5bba8ab671c8");
    }
