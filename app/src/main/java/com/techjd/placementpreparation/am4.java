...
public class am4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wva4);
        progressBar = findViewById(R.id.pba4);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/AMCAT%2FComputer%20Progrmming%20(3).pdf?alt=media&token=f42bffce-517c-466f-b72e-02056b1271bf");
