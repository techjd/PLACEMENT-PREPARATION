...
public class cap2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wvc2);
        progressBar = findViewById(R.id.pbc2);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/capgemini%2FCapgemini%20(1).pdf?alt=media&token=6161a4d1-b1fc-4ac3-a04e-6cb1b47b55e1");
    }
