...
public class audi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wv21);
        progressBar = findViewById(R.id.pb21);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/audi.pdf?alt=media&token=b0d0bc39-0815-4fd3-b851-d27e90401849");
