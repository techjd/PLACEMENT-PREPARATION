...
public class cc1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wvcc1);
        progressBar = findViewById(R.id.pbcc1);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/cocubes%2FQuantitative%20Aptitude.pdf?alt=media&token=dcd1bbd3-842a-4ea0-bead-6803f0b6abef");
    }
