...
public class lt1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wvlt1);
        progressBar = findViewById(R.id.pblt1);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/lt%2FROUND%20OVERVIEW.pdf?alt=media&token=55e8536a-97a6-4a38-8121-37dc897db6cd");
    }
