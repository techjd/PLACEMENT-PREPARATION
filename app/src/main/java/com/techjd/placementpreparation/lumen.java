...
public class lumen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        pdfView = findViewById(R.id.wv19);
        progressBar = findViewById(R.id.pb19);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/lumendata.pdf?alt=media&token=841d5471-5288-407e-b309-b380af24a376");
    }
