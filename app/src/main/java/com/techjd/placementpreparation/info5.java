...
public class info5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView = findViewById(R.id.wvinfo5);
        progressBar = findViewById(R.id.pbinfo5);

        new RetrievePDFStream().execute("https://firebasestorage.googleapis.com/v0/b/placement-preparation.appspot.com/o/Infosys%2FCopy%20of%20Infosys%20Aptitude%20Test.pdf?alt=media&token=1a88b09b-4b07-4a8f-a61a-ab1acf7341aa");
    }
